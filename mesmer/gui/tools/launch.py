...
import mesmer.lib.cli as cli

from tools_setup	import getArgsFromWindow,makeStringFromArgs
from tools_analysis	import openLogWindow,updateGenerationList
from win_analysis	import AnalysisWindow

def startRun( w ):

	args = getArgsFromWindow(w) # w in this context is a SetupWindow
	...
	w.pHandle = multiprocessing.Process(target=cli.run,args=args)
