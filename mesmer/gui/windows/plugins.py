...
class PluginWindow(tk.Frame):
	...
	def loadPrefs(self):
		...
		self.mesmer_path = set_module_paths()
	...
	def createWidgets(self):
		...
		self.addPluginButton = tk.Button(self.f_tools,text='Add...',command=lambda:revealDirectory(os.path.join(self.mesmer_path,'plugins')))
