...
class Ensemble(object):
	...
	def __init__(self, plugins, targets, size):
		...
		Args:
			plugins (list) The currently available Plugin modules
			targets (list):	The Targets this ensemble will be evaluated against
	...
	def get_fitness(self, components, plugins, target, ratios):
		...
		Args:
			...
			target (Target):	The restraint-containing target to evaluate fitness against
...
def load_ensemble_list_from_file( path, unique=False ):
	"""
