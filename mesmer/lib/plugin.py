...
class TargetPlugin(Plugin):
	...
	def __init__( self, *args, **kwargs ):
		...
		"""
		super(TargetPlugin, self).__init__(*args, **kwargs)
...
class TargetPluginDB( TargetPlugin ):
	...
	def __init__( self, cli_args, *args, **kwargs ):
		...
		"""
		super(TargetPluginDB, self).__init__(*args, **kwargs)
		
		# Use the provided scratch directory, or use system default temporary?
		if( cli_args.scratch ):
			self._db_path = os.path.join(cli_args.scratch,uuid.uuid1().hex)
		else:
