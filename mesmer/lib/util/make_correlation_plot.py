...
class MakeCorrelationPlot(MESMERUtility):
	def __init__(self):
		super(MakeCorrelationPlot, self).__init__()
	...
	def run(self,args):
		if(len(args.input)<1):
			return 1,"You must specify at least a correlation input file"
