...
def RDCFitSummary(soln,cov,info,mesg,success,p0,y_meas,type_of_fit):
    print 80*'-'
    if(type_of_fit == 0):
        print "Fitting Results: RDC X-tensor optimization"
    elif(type_of_fit == 1):
        print "Fitting Results: RDC X-tensor optimization, specified Dax, Drh"
    elif(type_of_fit == 2):
        print "Fitting Results: RDC X-tensor optimization, specified a, b, g"
